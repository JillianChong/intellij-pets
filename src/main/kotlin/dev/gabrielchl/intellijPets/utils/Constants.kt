...
object Constants {
    val PET_TYPES = arrayListOf("elefant");
    val PET_TO_SPRITE_SIZE: Map<String, Int> = java.util.Map.ofEntries(java.util.Map.entry("elefant", 40));
...
//        java.util.Map.entry("elefant", 40)
//    )
}